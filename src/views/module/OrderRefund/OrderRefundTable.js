...
import { getHistoryByNodeEnv } from '../../../utils'

class OrderTable extends Component {
    render() {
        let { data, onSelected, history } = this.props
        // console.info(data)
        let fetchProps = {
            fetch:{
                url:'/module/order/refund',
            ...
            columns: [
                ...
                { title: '数量', dataIndex: 'goods_num', key: 'goods_num' },
                ...
                { title: '支付时间', dataIndex: 'pay_time', key: 'pay_time', sorter: true },
                {
                  ...
                  render: (n,row) => {
                    return(
                        <div>
                        <a onClick={() => {history.push("/module/orderrefund/details/"+row.id)}}>详情</a>
                      	</div>);
                  } 
                },
            ]   
